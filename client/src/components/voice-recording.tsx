    ...
    return (
      <Card className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
        <div className="text-center py-8">
          ...
          <h3 className="text-lg font-medium text-slate-800 mb-2">Voice Recording Not Supported</h3>
          <p className="text-sm text-slate-600">
            Your browser doesn't support voice recording. Please try using Chrome or Safari.
          </p>
        </div>
      </Card>
    );
